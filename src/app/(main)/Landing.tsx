      ...
      <section className="relative min-h-[90dvh] w-full flex items-center justify-center pt-40 pb-10"   style={{ backgroundImage: `url('/assets/bg-img.jpeg')`, backgroundSize: 'cover',  }}>
        <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
          <motion.h1 
            ...
            className="text-[20vw] font-black text-white leading-none text-center tracking-tighter uppercase italic mt-20"
          >
            INVESTMENT
          </motion.h1>
        </div>
        ...
        <div className="relative z-10 mx-auto px-6 w-full">
          <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-12 lg:gap-4">
            ...
            >
              ...
              <motion.div animate={{ y: [0, -15, 0] }} transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }} className="relative w-full max-w-[320px] lg:max-w-[450px]">
            ...
            >
              <motion.div variants={fadeInUp} className="flex flex-wrap justify-center lg:justify-start gap-2">
              ...
              <motion.h2 variants={fadeInUp} className="text-4xl lg:text-[72px] font-black leading-[1] tracking-tighter text-white uppercase ">
                Auto-Invest, <br /> <span style={{ color: COLORS.brandNeon }}>Zero Stress</span> Strategy
              </motion.h2>
              <motion.p variants={fadeInUp} className="text-[#94A3B8] max-w-md mx-auto lg:mx-0">
    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <motion.div variants={fadeInUp} className="w-full lg:w-1/3 text-center lg:text-left">
          ...
          >
            <div className="space-y-4 max-w-2xl text-left">
              <motion.div variants={fadeInUp}>
                <Badge className="bg-[#ADFF2F]/10 text-[#ADFF2F] border border-[#ADFF2F]/20 px-4 py-1.5 rounded-full uppercase text-[11px] font-bold tracking-widest italic">Core Features</Badge>
              </motion.div>
              <motion.h2 variants={fadeInUp} className="text-4xl lg:text-6xl font-black text-white tracking-tighter leading-[1.1] uppercase italic">
                All-in-One Platform for <br /> <span className="opacity-30">Smarter Investing</span>
              </motion.h2>
            </div>
            <motion.div variants={fadeInUp}>
          ...
          >
            ...
            >
              ...
              <div className="relative z-10 space-y-4 max-w-sm text-left">
                <h3 className="text-3xl font-black text-white leading-tight uppercase italic">AI-Powered <br /> Investment Insights</h3>
            ...
            <div className="lg:col-span-5 flex flex-col gap-6">
              ...
              >
                 <div className="relative z-20 text-left">
                    <Badge className="bg-[#8A92FF]/10 text-[#8A92FF] mb-6 uppercase text-[10px] font-bold italic border-none">Updated</Badge>
                    <h3 className="text-xl font-black text-white uppercase italic leading-tight">Real-Time <br /> Market Data</h3>
              ...
              >
                 <div className="relative z-20 text-left">
                    <Badge className="bg-[#ADFF2F]/10 text-[#ADFF2F] mb-6 uppercase text-[10px] font-bold italic border-none">Asset</Badge>
                    <h3 className="text-xl font-black text-white uppercase italic leading-tight">Multi-Asset <br /> Support</h3>
