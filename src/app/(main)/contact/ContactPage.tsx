            ...
            <div className="grid gap-6 sm:gap-8">
              ...
              <div className="group relative flex flex-col sm:flex-row items-start sm:items-center gap-5 sm:gap-8 px-5 sm:px-8 py-6 sm:py-8 rounded-[1rem] bg-white/5 border border-white/10 hover:border-primary/50 hover:bg-white/[0.08] transition-all duration-500 cursor-pointer shadow-2xl">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-lg sm:text-xl font-semibold text-slate-100 mt-1 sm:mt-2 break-all">
                    <a
                      href="mailto:ai.app.space@gmail.com"
              ...
              <div className="group relative flex flex-col sm:flex-row items-start sm:items-center gap-5 sm:gap-8 px-5 sm:px-8 py-6 sm:py-8 rounded-[1rem] bg-white/5 border border-white/10 hover:border-green-400/50 hover:bg-white/[0.08] transition-all duration-500 cursor-pointer shadow-2xl">
                ...
                <div className="flex flex-col">
                  ...
                  >
                    <h3 className="text-[10px] sm:text-xs font-black uppercase tracking-[0.3em] text-slate-500 hover:text-green-400 group-hover:text-green-400 transition-colors">
                      Phone / WhatsApp
                    </h3>
                  </a>
                  ...
                  <p className="text-lg sm:text-xl font-semibold text-slate-100 mt-1 sm:mt-2 break-all">
                    <a
                      href="tel:+4916090338154"
                      className="hover:text-green-400 transition-colors"
                    >
                      +49 160 90338154 (Phone)
                    </a>{" "}
                    /{" "}
                    <a
                      href="https://wa.me/4916090338154"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-3 sm:mt-4 flex items-center gap-2 text-xs font-bold text-green-400 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 sm:translate-y-2 sm:group-hover:translate-y-0 transition-all duration-300"
                  >
          ...
          <div className="lg:col-span-7 bg-card/20 border border-border rounded-2xl p-6 sm:p-8 md:p-12 shadow-sm">
            <form className="space-y-6 sm:space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                <div className="space-y-3">
                  ...
                  <Input
                    ...
                    className="bg-background border-border h-12 w-full"
                  />
                </div>
              ...
              <div className="space-y-3">
                ...
                <Input
                  id="subject"
                  placeholder="Integration Inquiry"
                  className="bg-background border-border h-12 w-full"
                />
              </div>
              ...
              <Button
                type="submit"
                className="w-full h-14 text-md font-semibold bg-primary hover:bg-primary/90 transition-all rounded-lg"
              >
                Submit Transmission
              </Button>
            </form>
