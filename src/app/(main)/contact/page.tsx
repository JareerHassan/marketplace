          ...
          <div className="lg:col-span-5 space-y-10 sm:space-y-12">
            ...
            <div className="space-y-4 sm:space-y-6">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-semibold tracking-tight text-foreground leading-tight">
                Get in touch with our <span className="text-muted-foreground">technical team.</span>
              </h1>

              <p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-md">
                Whether you’re looking for enterprise solutions or have a quick question, we’re here to help.
              </p>
            </div>
