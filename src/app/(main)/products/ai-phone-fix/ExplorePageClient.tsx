  ...
  const steps = [
    {
      id: "#01",
      title: "Sign Up & Scan",
      desc: "Create your account and run your first full device scan.",
    },
    {
      id: "#02",
      title: "AI Analysis",
      desc: " Our AI engine analyzes system logs, performance metrics, and app behavior.",
    },
    {
      id: "#03",
      title: "Apply Fixes",
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          >
            ...
            <motion.h2
              ...
              variants={itemVariants}
            >
              Your All-in-One Mobile Optimization Platform
            </motion.h2>
            <motion.p
              className="text-[#6b6c75] mt-6 text-xl font-medium max-w-2xl mx-auto"
              variants={itemVariants}
            >
              Everything you need to diagnose, fix, and optimize your smartphone — in one simple app.
            </motion.p>
          </motion.div>
