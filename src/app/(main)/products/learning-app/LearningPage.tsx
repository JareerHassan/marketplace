...
export default function LandingPage() {
  ...
  const featurePanels = [
    {
      ...
      description:
        "Follow a structured curriculum designed to build strong cybersecurity foundations.",
    },
    {
      icon: <PieChart className="w-8 h-8 text-[#ccff00]" />,
      title: "AI Exam Simulator",
      description:
        "Practice under simulated test conditions with timed AI-powered exams.",
    },
    {
      icon: <BarChart3 className="w-8 h-8 text-[#ccff00]" />,
      title: "Performance Analytics",
      description:
        "Understand strengths and weaknesses with detailed analytics and improvement suggestions.",
    },
    {
      icon: <Zap className="w-8 h-8 text-[#ccff00]" />,
      title: "Continuous Updates",
      description:
        "Stay updated with new cybersecurity trends, vulnerabilities, and defensive techniques.",
    },
  ];
  ...
  const boxImage = "/assets/learningapps.png";
  return (
    <>
      <main
      ...
      >
        ...
        <section
          ...
          style={{
            backgroundImage: `url('/assets/learning-app.png')`,
            ...
            <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-12 lg:gap-4">
              ...
              <div className="order-2 lg:order-3 lg:col-span-5 text-center lg:text-left space-y-6">
                ...
                <p className="text-[#94A3B8] max-w-md mx-auto lg:mx-0">
                  ...
                  cybersecurity knowledge step by step.{" "}
                </p>
              ...
              <div className="lg:col-span-7 bg-[#0F1115] border border-white/5 rounded-[40px] p-8 lg:p-12 relative overflow-hidden group">
                ...
                <div className="relative z-10 space-y-4 max-w-md text-left">
                  ...
                  <p className="text-[#94A3B8] text-sm leading-relaxed">
                    Structured lessons covering cybersecurity fundamentals,
                    networking basics, Linux essentials, web security,
                    penetration testing concepts, and vulnerability analysis.
                  </p>
                </div>
              ...
              <div className="lg:col-span-5 flex flex-col gap-6">
                ...
                <div className="flex-1 bg-[#0F1115] border border-white/5 rounded-[40px] p-8 relative overflow-hidden group min-h-[220px]">
                  <div className="relative z-20 text-left">
                    ...
                    <p className="text-sm text-[#94A3B8] mt-2 font-medium">
                      The system analyzes your answers and adjusts difficulty
                      based on your performance. Weak areas are automatically
                ...
                <div className="flex-1 bg-[#0F1115] border border-white/5 rounded-[40px] p-8 relative overflow-hidden group min-h-[220px]">
                  <div className="relative z-20 text-left">
                    ...
                    <h3 className="text-xl font-black text-white uppercase  leading-tight">
                      AI-Based Practice Exams
                    </h3>
                    <p className="text-sm text-[#94A3B8] mt-2 font-medium">
                      Prepare for real-world cybersecurity certifications with
                      AI-generated mock exams. Simulated exam environments help
                      you build confidence and improve problem-solving speed.
                    </p>
                  </div>
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="md:w-2/3">
              <p className="text-gray-600 text-lg leading-relaxed">
                Founded by cybersecurity professionals and AI engineers, our
                mission is to make ethical hacking education structured,
                accessible, and responsible. We combine artificial intelligence,
                interactive quizzes, and real-world cybersecurity knowledge to
                create a learning experience that is practical and effective.
              </p>
            </motion.div>
          </motion.div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-8 mb-16">
            ...
            <div className="md:w-1/4 pt-10">
              <p className="text-gray-500 text-sm leading-relaxed">
                Learning ethical hacking should be guided, ethical, and
                practica{" "}
              </p>
            </div>
          </div>
              ...
              <div className="flex flex-col gap-5">
                ...
                >
                  <div>
                    ...
                    <h3 className="text-white text-4xl font-bold mt-2">5000</h3>
                  </div>
        ...
        <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              Join thousands of learners building ethical hacking skills with
